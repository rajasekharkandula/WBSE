  <!-- Start: Header -->
	...
	<div class="topbar-dropmenu" id="topbar-dropmenu2">
		<div class="topbar-menu row">
			...
			<div class="col-xs-4 col-sm-2">
				<a href="/WBSE/home/list_users" class="metro-tile bg-dark">
					<span class="fa fa-user"></span>
			...
			<div class="col-xs-4 col-sm-2">
				<a href="/WBSE/home/calender" class="metro-tile bg-dark">
					<span class="fa fa-user"></span>
					<span class="metro-title">Calender</span>
				</a>
			</div>
			<?php endif;?>
			<?php if(in_array('Administrator',$role)):?>
			<div class="col-xs-4 col-sm-2">
				<a href="/WBSE/home/calenderAdmin" class="metro-tile bg-dark">
					<span class="fa fa-user"></span>
					<span class="metro-title">Attendance</span>
				</a>
			</div>
			<?php endif;?>
			<?php if($this->session->userdata('login')){?>
